...
2. Save the existing front-end unit and `tailscale serve status --json` in the private release evidence directory. Confirm the port-443 handlers still point `/` to 8787 and `/docs` to 8790.
